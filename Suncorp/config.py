"""Client-specific configuration for Suncorp AWS Daily Health Check."""
...
# NOTE: account 616476889381 is NOT bootstrap.CLIENTS["Suncorp"] (that entry is a different,
# pre-existing client account: 889716922160). It's the same account already used by MGL/IAG/LFS.
...
LOG_GROUPS = {
    "application": "suncorp-prod-ApplicationLogs-1UJ5BFKEPYENB",
}
...
LOG_STREAMS = {
    ...
    "norkom": "batch/i-0f21d05f500461007/batch/norkom.log",
    "run_batch": "batch/i-0f21d05f500461007/batch/runBatch.log",
}
...
# to find Suncorp's production resources - e.g. "suncorp-production-compute...".
INFRA_NAME_FILTER = ("suncorp", "production")

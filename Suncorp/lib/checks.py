"""Independent CloudWatch Logs Insights / AWS API health-check functions for Suncorp.
...
def _run_stream(logs_client, log_group: str, stream: str, lookback_minutes: int,
    ...
    """
    # Use a quoted substring match, not /regex/ - Suncorp's stream names contain literal "/"

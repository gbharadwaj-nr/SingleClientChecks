"""
Coop AWS Daily Health Check.

Runs a set of independent checks - EC2/RDS/ASG/EFS (direct AWS API calls) plus Factiva
Import, RunBatch Activity and Payment Fraud (CloudWatch Logs Insights against specific
log streams) - prints a console health report, and renders the same standard client

"""Client-specific configuration for Coop AWS Daily Health Check."""
...
AWS_ACCOUNT_ID = CLIENTS["Coop"]["account_id"]
...
LOG_GROUPS = {
    "application": "tcb-production-ApplicationLogs-1EA6ZK9W1E7TR",
}
...
# to find Coop's production resources - real naming is "tcb-production-...".
INFRA_NAME_FILTER = ("tcb", "production")

"""Independent CloudWatch Logs Insights / AWS API health-check functions for Equifax.
...
def _run_stream(logs_client, log_group: str, stream: str, lookback_minutes: int,
    ...
    """
    # Use a quoted substring match, not /regex/ - Equifax's stream names contain literal "/"

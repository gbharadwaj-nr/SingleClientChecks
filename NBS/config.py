"""Client-specific configuration for NBS AWS Daily Health Check."""
...
AWS_ACCOUNT_ID = CLIENTS["NBS"]["account_id"]
...
LOG_GROUPS = {
    "application": "nbs-production-ApplicationLogs-R61ymC3Urekz",
}

# Specific log streams used by the per-stream checks in lib/checks.py.
LOG_STREAMS = {
    "run_batch": "batch/i-07f977fc837483705/batch/runBatch.log",
}
...
# to find NBS's production resources - e.g. "nbs-production-compute...".
INFRA_NAME_FILTER = ("nbs", "production")

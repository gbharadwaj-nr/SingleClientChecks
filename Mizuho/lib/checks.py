"""Independent CloudWatch Logs Insights / AWS API health-check functions for Mizuho.
...
def _run_stream(logs_client, log_group: str, stream: str, lookback_minutes: int,
    ...
    """
    # Use a quoted substring match, not /regex/ - Mizuho's stream names contain literal "/"
    # (e.g. "dmz/i-.../initiatePipeline.log"), which breaks the /regex/ delimiter syntax.

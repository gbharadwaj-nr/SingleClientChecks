"""
Generali AWS Daily Health Check.

Runs a set of independent checks - EC2/RDS/ASG/EFS (direct AWS API calls) plus RunBatch
Activity and Bad Files (CloudWatch Logs Insights against a specific log stream) - prints
a console health report, and renders the same standard client HTML report used by the
